    ...
    public function up(): void
    {
        Schema::table('users', function (Blueprint $table) {
            if (!Schema::hasColumn('users', 'profile_photo_path')) {
                $table->string('profile_photo_path')->nullable()->after('mobility_aids');
            }
            ...
            if (!Schema::hasColumn('users', 'emergency_contact_name')) {
                $table->string('emergency_contact_name')->nullable()->after('mobility_aids');
            }
            ...
            if (!Schema::hasColumn('users', 'assistance_needs')) {
                $table->text('assistance_needs')->nullable()->after('emergency_contact_phone');
            }
        });
    }
