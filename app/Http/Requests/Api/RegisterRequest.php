...
class RegisterRequest extends ApiFormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'id_document' => ['nullable', 'file', 'extensions:jpg,jpeg,png,pdf', 'max:5120', 'required_if:role,volunteer'],
            'certification_document' => ['nullable', 'file', 'extensions:jpg,jpeg,png,pdf', 'max:5120'],
            'certification' => ['nullable', 'file', 'extensions:jpg,jpeg,png,pdf', 'max:5120'],
